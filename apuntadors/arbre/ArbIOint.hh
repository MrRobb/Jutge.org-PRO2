...
// s'introdueixen en preordre: primer l'arrel, desprÈs el subarbre
...
/* Exemple: l'arbre 
  ...
  2     3
   ...
   es llegeix 1 2 0 0 3 0 0 (o amb els números en diferents línies) */
...
/* Pre: cert */ 
/* Post: El canal estàndard de sortida conté el recorregut en inordre d'a */
  if (not a.es_buit()) {
    Arbre<int> a1;
    Arbre<int> a2;
    int x = a.arrel();
