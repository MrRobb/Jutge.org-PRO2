...
template <class T> class ArbreGen {
  ...
  // aporta el cost de crear, esborrar o copiar la seva info); plantar
  // (segona versio) i fills son lineals respecte a l'aritat de l'arbre;
  // afegir_fill i fill son lineals respecte a la mida del fill afegit o
  // consultat
...
public:
  ...
  void fill(const ArbreGen& a, int i) {
    ...
    /* Post: el p.i Ès una còpia del fill i-èsim d'a */
  ...
  //// extensió: programeu-la en un altre fitxer i traieu el comentari
