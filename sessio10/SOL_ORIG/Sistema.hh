...
public:
  ...
  */
  ...
  /** @brief Modificadora que gestiona el intento de entrada de un organismo en el sistema
      ...
      \coste Lineal respecto al número de organismos del sistema (el coste de tratar cada organismo es lineal respecto a su número de células y el coste de tratar cada célula es lineal respecto a su número de parámetros)
  */
  ...
  /** @brief Operación de lectura
      \pre N>0, el canal estándard de entrada contiene un entero M > 0 seguido de los datos de M organismos
      \post El parámetro implícito está formado por los M organismos procedentes del canal estándard de entrada y formados por celulas de N parámetros
      \coste Lineal respecto al número de organismos leídos (ver comentario en el coste de la operación "anadir_organismo")
  */
  void leer(int N);
  ...
  /** @brief Operación de escritura
      ...
      \coste Lineal respecto al número de organismos escritos (si "estr" es cierto, ver comentario en el coste de la operación "anadir_organismo")
  */
...
private:
  ...
  /** @brief Lucha de un organismo contra los organismos de una cola
      ...
      @coste Lineal respecto al número de organismos en C (ver comentario en 
      el coste de la operación "anadir_organismo") 
  */
...
static void clear(queue<Organismo>& q);
  ...
  /** @brief Pasa los n primeros organismos de una cola al final de ésta, conservando el orden relativo
      ...
      @coste Lineal respecto a n (ver comentario en el coste de la operación "anadir_organismo")
  */
